                                    ...
                                    <div class="position-relative h-100 d-flex flex-column">
                                        <div class="mb-4">
                                            <a href="index.html" class="d-block">
                                                <img src="admin_assets/images/logo-light.png" alt="" height="18">
                                            </a>
                                        </div>
                                        <div class="mt-auto">
                                            <div class="mb-3">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="email" type="email" name="email" required autofocus  placeholder="Enter username">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative auth-pass-inputgroup mb-3">
                                                    <input type="password" class="form-control pe-5" type="password"
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0">&copy; <script>document.write(new Date().getFullYear())</script> © RobamSa. Designed & Developed by ShiftTech</p>
                    </div>
                </div>
            </div>
